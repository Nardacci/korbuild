...
<div id="schedule-group" class="nav-group" style="margin:2px 0">${groupBtn('schedule','Schedule',groupActive.schedule)}<div id="schedule-items" class="nav-group-items" style="display:${groupActive.schedule?'block':'none'};padding-left:8px">${navItem(active.schedule,'schedule.html','▤','Schedule')}<div id="customer-service-group" class="nav-group" style="margin:2px 0">${groupBtn('customer-service','Customer Service',groupActive.customerService)}<div id="customer-service-items" class="nav-group-items" style="display:${groupActive.customerService?'block':'none'};padding-left:8px">${navItem(active.customerCalendar,'customer-schedule.html','▦','Calendar')}${navItem(active.customers,'customers.html','☺','Clients')}${navItem(active.services,'services.html','◆','Services')}${navItem(active.reminderSettings,'reminder-settings.html','✉','Reminders')}</div></div></div></div>
