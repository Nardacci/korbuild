...
if (!document.querySelector('link[data-korbuild-ui-fixes]')) { const style=document.createElement('link');style.rel='stylesheet';style.href='ui-fixes.css?v=1.2.7';style.dataset.korbuildUiFixes='true';document.head.appendChild(style); }
