...
(function () {
  ...
  const DICT = {
    ...
    "Back to Teams": "Voltar para Equipes",
    "Define the operational team that people will belong to.": "Defina a equipe operacional à qual as pessoas pertencerão.",
    "New Team": "Nova Equipe",
    "NEW TEAM": "NOVA EQUIPE",
    "Add team": "Adicionar equipe",
    "Team information": "Informações da equipe",
    "Give the team a clear name and operational work unit.": "Dê à equipe um nome claro e uma unidade de trabalho operacional.",
    "Team name": "Nome da equipe",
    "Select a work unit": "Selecionar uma unidade de trabalho",
    "Work unit": "Unidade de trabalho",
    "e.g. Field Operations": "ex.: Operações de Campo",
    "Team status": "Status da equipe",
    "Inactive teams remain available for historical reference and cannot receive new active People.": "Equipes inativas permanecem disponíveis para referência histórica e não podem receber novas pessoas ativas.",
    "Active team": "Equipe ativa",
    "Active teams are available for People assignment.": "Equipes ativas estão disponíveis para atribuição de pessoas.",
    "Save Team": "Salvar Equipe",
    "Loading work units...": "Carregando unidades de trabalho...",
    "Unable to load work units": "Não foi possível carregar as unidades de trabalho",
    "Unable to load work units.": "Não foi possível carregar as unidades de trabalho.",
    "Create at least one active Work Unit before adding a Team.": "Crie pelo menos uma Unidade de Trabalho ativa antes de adicionar uma Equipe.",
    "Team not found.": "Equipe não encontrada.",
    "EDIT TEAM": "EDITAR EQUIPE",
    "Edit team": "Editar equipe",
    "Edit Team": "Editar Equipe",
    "Team name is required.": "O nome da equipe é obrigatório.",
    "A Work Unit is required before a Team can be saved.": "Uma Unidade de Trabalho é obrigatória antes que uma Equipe possa ser salva.",
    "Team updated successfully.": "Equipe atualizada com sucesso.",
    "Team created successfully.": "Equipe criada com sucesso.",
    "We couldn't save this team.": "Não foi possível salvar esta equipe.",
    "Back to Work Units": "Voltar para Unidades de Trabalho",
    "Define the operational location where Teams will be organized.": "Defina o local operacional onde as Equipes serão organizadas.",
    "New Work Unit": "Nova Unidade de Trabalho",
    "NEW WORK UNIT": "NOVA UNIDADE DE TRABALHO",
    "Add work unit": "Adicionar unidade de trabalho",
    "Work unit information": "Informações da unidade de trabalho",
    "Identify the work unit used throughout KORbuild.": "Identifique a unidade de trabalho usada em todo o KORbuild.",
    "Work unit name": "Nome da unidade de trabalho",
    "Code": "Código",
    "e.g. DT-001": "ex.: DT-001",
    "Brief description of this work unit...": "Breve descrição desta unidade de trabalho...",
    "Work unit status": "Status da unidade de trabalho",
    "Inactive work units remain available for historical reference.": "Unidades de trabalho inativas permanecem disponíveis para referência histórica.",
    "Active work unit": "Unidade de trabalho ativa",
    "Active work units are available for Team assignment.": "Unidades de trabalho ativas estão disponíveis para atribuição de equipes.",
    "Save Work Unit": "Salvar Unidade de Trabalho",
    "e.g. Downtown Project": "ex.: Projeto Centro",
    "Work unit not found.": "Unidade de trabalho não encontrada.",
    "EDIT WORK UNIT": "EDITAR UNIDADE DE TRABALHO",
    "Edit work unit": "Editar unidade de trabalho",
    "Edit Work Unit": "Editar Unidade de Trabalho",
    "Work unit name is required.": "O nome da unidade de trabalho é obrigatório.",
    "Work unit updated successfully.": "Unidade de trabalho atualizada com sucesso.",
    "Work unit created successfully.": "Unidade de trabalho criada com sucesso.",
    "We couldn't save this work unit.": "Não foi possível salvar esta unidade de trabalho.",
    "New Occurrence": "Nova Ocorrência",
    "Configure an occurrence type available to evaluators.": "Configure um tipo de ocorrência disponível para avaliadores.",
    "Points *": "Pontos *",
    "Describe when this occurrence should be applied.": "Descreva quando esta ocorrência deve ser aplicada.",
    "Negative": "Negativa",
    "Positive": "Positiva",
    "Save Occurrence": "Salvar Ocorrência",
    "e.g. Late arrival": "ex.: Atraso na chegada",
    "EDIT": "EDITAR",
    "Edit Occurrence": "Editar Ocorrência",
    "Occurrence not found.": "Ocorrência não encontrada.",
    "Points must be zero or greater.": "Os pontos devem ser zero ou maiores.",
    "Unable to save Occurrence.": "Não foi possível salvar a Ocorrência.",
    ...
    "Build better teams.": "Construa equipes melhores.",
    "Run better operations.": "Opere melhor.",
    "Start with 14 days free": "Comece com 14 dias grátis",
    "No payment required to get started.": "Nenhum pagamento necessário para começar.",
    "CREATE YOUR WORKSPACE": "CRIE SEU WORKSPACE",
    "Start building better.": "Comece a construir melhor.",
    "Create your company account and start your 14-day free trial.": "Crie a conta da sua empresa e comece seu teste grátis de 14 dias.",
    "Full name": "Nome completo",
    "Work email": "E-mail profissional",
    "Confirm password": "Confirmar senha",
    "I agree to the Terms of Service and Privacy Policy.": "Concordo com os Termos de Serviço e a Política de Privacidade.",
    ...
    "You must accept the Terms of Service and Privacy Policy.": "Você deve aceitar os Termos de Serviço e a Política de Privacidade.",
    "Authentication service is not available. Please refresh and try again.": "O serviço de autenticação não está disponível. Atualize a página e tente novamente.",
    "Creating account...": "Criando conta...",
    "Creating your account...": "Criando sua conta...",
    "Unable to create your account. Please try again.": "Não foi possível criar sua conta. Tente novamente.",
    "WELCOME TO KORBUILD": "BEM-VINDO AO KORBUILD",
    "Welcome aboard!": "Seja bem-vindo!",
    "You're about to build better teams and run better operations.": "Você está prestes a construir equipes melhores e operar melhor.",
    "KORBuild helps organizations create clearer performance processes, recognize contributions and connect team results to real business outcomes.": "O KORbuild ajuda organizações a criar processos de desempenho mais claros, reconhecer contribuições e conectar os resultados da equipe a resultados reais de negócio.",
    "CONFIRM YOUR EMAIL": "CONFIRME SEU E-MAIL",
    "One more step to get started.": "Mais um passo para começar.",
    "We've sent a confirmation link to:": "Enviamos um link de confirmação para:",
    "Please check your inbox and click the confirmation link to activate your account.": "Verifique sua caixa de entrada e clique no link de confirmação para ativar sua conta.",
    "Didn't receive the email?": "Não recebeu o e-mail?",
    "Resend confirmation email": "Reenviar e-mail de confirmação",
    "Already confirmed your email?": "Já confirmou seu e-mail?",
    "your email address": "seu endereço de e-mail",
    "We could not identify your email. Please return to sign up.": "Não conseguimos identificar seu e-mail. Volte para a página de cadastro.",
    "Email service is unavailable. Please refresh and try again.": "O serviço de e-mail não está disponível. Atualize a página e tente novamente.",
    "Sending...": "Enviando...",
    "Confirmation email sent. Please check your inbox.": "E-mail de confirmação enviado. Verifique sua caixa de entrada.",
    "Unable to resend the confirmation email. Please try again.": "Não foi possível reenviar o e-mail de confirmação. Tente novamente.",
    "EMAIL CONFIRMED": "E-MAIL CONFIRMADO",
    "Your account is ready.": "Sua conta está pronta.",
    "Your email has been confirmed successfully. Sign in to continue setting up your KORbuild workspace.": "Seu e-mail foi confirmado com sucesso. Entre para continuar configurando seu workspace no KORbuild.",
    "Go to Sign in": "Ir para o login",
    "Review the consolidated result of each Bonus Cycle and open the final settlement report.": "Revise o resultado consolidado de cada Ciclo de Bônus e abra o relatório final de fechamento.",
    "BONUS CYCLES": "CICLOS DE BÔNUS",
    "Select a cycle to view the settlement.": "Selecione um ciclo para ver o fechamento.",
    "Cycle": "Ciclo",
    "Loading Bonus Cycles...": "Carregando Ciclos de Bônus...",
    "All Bonus Cycles": "Todos os Ciclos de Bônus",
    "Print / PDF": "Imprimir / PDF",
    "ELIGIBLE PEOPLE": "PESSOAS ELEGÍVEIS",
    "Active people in the settlement": "Pessoas ativas no fechamento",
    "EVALUATED PEOPLE": "PESSOAS AVALIADAS",
    "People with recorded evaluation data": "Pessoas com dados de avaliação registrados",
    "TOTAL DEDUCTIONS": "TOTAL DE DEDUÇÕES",
    "Points deducted during the cycle": "Pontos deduzidos durante o ciclo",
    "TOTAL BONUS": "BÔNUS TOTAL",
    "Final amount to be paid": "Valor final a pagar",
    "CONSOLIDATED SETTLEMENT": "FECHAMENTO CONSOLIDADO",
    "Grouped by Work Unit and Team.": "Agrupado por Unidade de Trabalho e Equipe.",
    "FUNCTION": "FUNÇÃO",
    "STARTING BALANCE": "SALDO INICIAL",
    "DEDUCTIONS": "DEDUÇÕES",
    "FINAL BALANCE": "SALDO FINAL",
    "BONUS AMOUNT": "VALOR DO BÔNUS",
    "TOTAL BONUS TO PAY": "TOTAL DE BÔNUS A PAGAR",
    "Loading cycle information...": "Carregando informações do ciclo...",
    "BONUS SETTLEMENT": "FECHAMENTO DE BÔNUS",
    "No Bonus Cycles available yet.": "Nenhum Ciclo de Bônus disponível ainda.",
    "Open report": "Abrir relatório",
    "Calculating settlement...": "Calculando fechamento...",
    "Unable to calculate settlement:": "Não foi possível calcular o fechamento:",
    "Unknown error": "Erro desconhecido",
    "No Work Unit": "Sem Unidade de Trabalho",
    "No Team": "Sem Equipe",
    "Work Unit": "Unidade de Trabalho",
    "Team": "Equipe",
    "No eligible people found for this settlement.": "Nenhuma pessoa elegível encontrada para este fechamento.",
    "Unable to load Bonus Cycles.": "Não foi possível carregar os Ciclos de Bônus.",
    "Final balance ×": "Saldo final ×",
    "per point": "por ponto",
    "Detailed occurrence history by collaborator and evaluation period.": "Histórico detalhado de ocorrências por colaborador e período de avaliação.",
    "Search collaborator, work unit, team or function...": "Buscar colaborador, unidade de trabalho, equipe ou função...",
    "All periods": "Todos os períodos",
    "Loading collaborator movements...": "Carregando movimentações de colaboradores...",
    "collaborators with movement": "colaboradores com movimentação",
    "No collaborator movement found for the selected filters.": "Nenhuma movimentação de colaborador encontrada para os filtros selecionados.",
    "TOTAL MOVEMENT": "MOVIMENTAÇÃO TOTAL",
    "EVALUATION PERIOD": "PERÍODO DE AVALIAÇÃO",
    "OCCURRENCE": "OCORRÊNCIA",
    "QUANTITY": "QUANTIDADE",
    "MOVEMENT": "MOVIMENTAÇÃO",
    "Unable to load collaborator movement.": "Não foi possível carregar a movimentação de colaboradores.",
    "Occurrence": "Ocorrência",
    "Period": "Período",
