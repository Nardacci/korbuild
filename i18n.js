...
(function(){
  'use strict';
  const DICT={
    'TEAM OPERATIONS PLATFORM':'PLATAFORMA DE OPERAÇÕES DE EQUIPE','WELCOME BACK':'BEM-VINDO DE VOLTA','Sign in':'Entrar','Access your company workspace.':'Acesse o workspace da sua empresa.','Email':'E-mail','Password':'Senha','New to KORbuild?':'Novo no KORbuild?','Create your workspace':'Criar seu workspace','Dashboard':'Dashboard','Overview of your current operational cycle and key performance indicators.':'Visão geral do seu ciclo operacional atual e dos principais indicadores de desempenho.','Workspace Setup':'Configuração do Workspace','CURRENT OPEN PERIOD':'PERÍODO ABERTO ATUAL','No open period':'Nenhum período aberto','View period details':'Ver detalhes do período','WORKSPACE HEALTH':'SAÚDE DO WORKSPACE','Complete your workspace':'Complete seu workspace',"These foundations are not required for setup, but you'll need them before running team operations.":'Essas bases não são obrigatórias para a configuração, mas serão necessárias antes de executar as operações da equipe.','Create your first team':'Crie sua primeira equipe','Organize your people before starting evaluations.':'Organize suas pessoas antes de iniciar as avaliações.','Create team →':'Criar equipe →','Add your people':'Adicione suas pessoas','Build your organization and prepare your first operational cycle.':'Estruture sua organização e prepare seu primeiro ciclo operacional.','Add people →':'Adicionar pessoas →','ATTENTION REQUIRED':'ATENÇÃO NECESSÁRIA','View all':'Ver todos','Pending evaluations':'Avaliações pendentes','Collaborators still need attention':'Colaboradores que ainda precisam de atenção','Review now →':'Revisar agora →','Prepare a period to start weekly operations':'Prepare um período para iniciar as operações semanais','Go to periods →':'Ir para períodos →','WEEKLY SNAPSHOT':'RESUMO SEMANAL','Eligible People':'Pessoas elegíveis','This period':'Neste período','Evaluated':'Avaliados','No data yet':'Ainda não há dados','Pending':'Pendentes','Total Occurrences':'Total de ocorrências','Teams':'Equipes','Active':'Ativas','PERFORMANCE OVERVIEW':'VISÃO GERAL DO DESEMPENHO','People':'Pessoas','High Performance':'Alto desempenho','On Track':'No ritmo esperado','Attention Needed':'Atenção necessária','Critical':'Crítico','View evaluations →':'Ver avaliações →','POINTS SUMMARY':'RESUMO DE PONTOS','Positive Points':'Pontos positivos','Negative Points':'Pontos negativos','View detailed analysis →':'Ver análise detalhada →','TOP POSITIVE PERFORMERS':'MELHORES DESEMPENHOS POSITIVOS','No positive movements in this period.':'Nenhum movimento positivo neste período.','ATTENTION NEEDED':'ATENÇÃO NECESSÁRIA','No negative movements in this period.':'Nenhum movimento negativo neste período.','QUICK ACTIONS':'AÇÕES RÁPIDAS','Manage Occurrences':'Gerenciar ocorrências','Configure evaluation events':'Configurar eventos de avaliação','Manage People':'Gerenciar pessoas','Add or edit collaborators':'Adicionar ou editar colaboradores','View Evaluations':'Ver avaliações','Browse current evaluations':'Consultar avaliações atuais','Open Settlement':'Abrir fechamento','Process period settlement':'Processar fechamento do período','KORbuild AI':'KORbuild AI','Your intelligent workspace assistant':'Seu assistente inteligente do workspace','Close':'Fechar','How can I help?':'Como posso ajudar?','I understand your workspace and can help you navigate, analyze and manage your work.':'Entendo seu workspace e posso ajudar você a navegar, analisar e gerenciar seu trabalho.','Dashboard context loaded':'Contexto do dashboard carregado','Operational insights':'Insights operacionais','Explain this dashboard':'Explique este dashboard','What requires my attention?':'O que requer minha atenção?','Summarize current performance':'Resuma o desempenho atual','Ask KORbuild AI...':'Pergunte ao KORbuild AI...','Send':'Enviar','Context-aware assistance':'Assistência com contexto','Evaluations':'Avaliações','Record occurrences for collaborators in the current open period.':'Registre ocorrências para colaboradores no período aberto atual.','Periods':'Períodos','Bonuses':'Bônus','Records':'Registros','Work Units':'Unidades de trabalho','Occurrences':'Ocorrências','Reports':'Relatórios','Sign out':'Sair','OPEN PERIOD':'PERÍODO ABERTO','Loading current period...':'Carregando período atual...','Search by person, work unit, team or specialty...':'Pesquisar por pessoa, unidade de trabalho, equipe ou especialidade...','PERSON':'PESSOA','WORK UNIT':'UNIDADE DE TRABALHO','TEAM':'EQUIPE','SPECIALTY / FUNCTION':'ESPECIALIDADE / FUNÇÃO','OCCURRENCES':'OCORRÊNCIAS','TOTAL':'TOTAL','No collaborators found':'Nenhum colaborador encontrado','There are no prepared collaborators for the current open period.':'Não há colaboradores preparados para o período aberto atual.','Back to collaborators':'Voltar para colaboradores','Collaborator':'Colaborador','Loading prepared occurrences...':'Carregando ocorrências preparadas...','YOUR FREE TRIAL':'SEU TESTE GRATUITO','Your KORbuild trial is active':'Seu teste do KORbuild está ativo','You have full access to KORbuild.':'Você tem acesso completo ao KORbuild.','days free':'dias grátis','Subscribe now →':'Assinar agora →','Ends today':'Termina hoje','Ends in 1 day':'Termina em 1 dia','Ends in {n} days':'Termina em {n} dias','Period ends today':'O período termina hoje','Period ends tomorrow':'O período termina amanhã','Period ends in 1 day':'O período termina em 1 dia','Period ends in {n} days':'O período termina em {n} dias','Review all occurrences before settlement':'Revise todas as ocorrências antes do fechamento','Period ended':'Período encerrado','Review period settlement':'Revisar fechamento do período','Check evaluations before closing the cycle':'Verifique as avaliações antes de fechar o ciclo','Prepare your next evaluation period to start the operation.':'Prepare seu próximo período de avaliação para iniciar a operação.','No movements in this period.':'Nenhum movimento neste período.','6 of 6 days completed':'6 de 6 dias concluídos','day remaining':'dia restante','days remaining':'dias restantes','day free':'dia grátis','TRIAL ENDED · GRACE PERIOD':'TESTE ENCERRADO · PERÍODO DE TOLERÂNCIA','Your trial has ended, but KORbuild is still available.':'Seu teste terminou, mas o KORbuild continua disponível.','Choose a plan to keep your workspace active without interruption.':'Escolha um plano para manter seu workspace ativo sem interrupções.','Choose a plan →':'Escolha um plano →','TRIAL EXPIRED':'TESTE EXPIRADO','Your KORbuild trial has expired.':'Seu teste do KORbuild expirou.','Choose a plan to restore access to your workspace.':'Escolha um plano para restaurar o acesso ao seu workspace.','Explore the platform and build your workspace with full access.':'Explore a plataforma e estruture seu workspace com acesso completo.','View plans →':'Ver planos →',
    'Let's get your workspace ready.':'Vamos preparar seu workspace.','We’ll configure the essentials before you start your first evaluation cycle.':'Vamos configurar o essencial antes de você iniciar seu primeiro ciclo de avaliação.',"We'll configure the essentials before you start your first evaluation cycle.":'Vamos configurar o essencial antes de você iniciar seu primeiro ciclo de avaliação.','of 5':'de 5','Company':'Empresa','Evaluation':'Avaliação','Bonus Cycle':'Ciclo de Bônus','Evaluation Period':'Período de Avaliação','Review':'Revisão','STEP 1 · COMPANY':'ETAPA 1 · EMPRESA','Tell us about your company.':'Conte-nos sobre sua empresa.','This creates your KORbuild workspace. You can review and expand these details later.':'Isso cria seu workspace KORbuild. Você poderá revisar e ampliar esses dados depois.','Company name':'Nome da empresa','Your company':'Sua empresa','The name of your KORbuild workspace.':'O nome do seu workspace KORbuild.','Owner name':'Nome do responsável','Your full name':'Seu nome completo','The primary owner of this workspace.':'O responsável principal por este workspace.','Your company workspace is created only after you confirm this step. Until then, your account remains independent and no company is provisioned.':'O workspace da sua empresa só será criado depois que você confirmar esta etapa. Até lá, sua conta permanece independente e nenhuma empresa é provisionada.','STEP 2 · EVALUATION':'ETAPA 2 · AVALIAÇÃO','How should KORbuild score your team?':'Como o KORbuild deve pontuar sua equipe?','Define the starting points and the financial value represented by each point.':'Defina os pontos iniciais e o valor financeiro representado por cada ponto.','Starting points per employee':'Pontos iniciais por colaborador','Points assigned when the first Bonus Cycle is opened.':'Pontos atribuídos quando o primeiro Ciclo de Bônus for aberto.','Value per point':'Valor por ponto','Amount in USD represented by one point.':'Valor em USD representado por um ponto.','At the start of a new Bonus Cycle, each employee receives the configured starting balance. Evaluation Periods carry the previous closing balance forward.':'No início de um novo Ciclo de Bônus, cada colaborador recebe o saldo inicial configurado. Os Períodos de Avaliação carregam o saldo de fechamento anterior.','STEP 3 · BONUS CYCLE':'ETAPA 3 · CICLO DE BÔNUS','Define your Bonus Cycle.':'Defina seu Ciclo de Bônus.','The macro cycle contains all Evaluation Periods used to calculate the final bonus result.':'O ciclo macro contém todos os Períodos de Avaliação usados para calcular o resultado final do bônus.','Cycle name':'Nome do ciclo','Name this Bonus Cycle.':'Dê um nome a este Ciclo de Bônus.','Year':'Ano','The calendar year for this Bonus Cycle.':'O ano-calendário deste Ciclo de Bônus.','Start month':'Mês inicial','The month in which each Bonus Cycle opens.':'O mês em que cada Ciclo de Bônus é aberto.','End month':'Mês final','The month in which the Bonus Cycle closes.':'O mês em que o Ciclo de Bônus é encerrado.','The Year defines the calendar year for this Bonus Cycle. Start and End Month define the operating window within that year.':'O Ano define o ano-calendário deste Ciclo de Bônus. Os meses inicial e final definem a janela operacional dentro desse ano.','STEP 4 · EVALUATION PERIOD':'ETAPA 4 · PERÍODO DE AVALIAÇÃO','Define your Evaluation Periods.':'Defina seus Períodos de Avaliação.','Set the recurring operational cycle used for launches, occurrences and point deductions.':'Defina o ciclo operacional recorrente usado para lançamentos, ocorrências e deduções de pontos.','Frequency':'Frequência','Every 2 weeks':'A cada 2 semanas','Monthly':'Mensal','Weekly':'Semanal','Period starts':'Início do período','Period ends':'Fim do período','First day of the Evaluation Period.':'Primeiro dia do Período de Avaliação.','Last day of the Evaluation Period.':'Último dia do Período de Avaliação.','How should KORbuild prepare the next period?':'Como o KORbuild deve preparar o próximo período?','Manual':'Manual','Prepare the next period whenever you’re ready.':'Prepare o próximo período quando estiver pronto.',"Prepare the next period whenever you're ready.":'Prepare o próximo período quando estiver pronto.','Automatic':'Automático','KORbuild prepares the next period automatically.':'O KORbuild prepara o próximo período automaticamente.','Prepare next period on':'Preparar próximo período em','You can always prepare the next period manually.':'Você sempre pode preparar o próximo período manualmente.','Manual preparation is always available.':'A preparação manual está sempre disponível.','Even with Automatic enabled, the Owner can prepare a period manually at any time.':'Mesmo com o modo Automático ativado, o responsável pode preparar um período manualmente a qualquer momento.','STEP 5 · REVIEW & CONFIRM':'ETAPA 5 · REVISÃO E CONFIRMAÇÃO','Review your configuration.':'Revise sua configuração.','Everything looks good? Confirm how KORbuild will operate your workspace.':'Tudo certo? Confirme como o KORbuild irá operar seu workspace.','EVALUATION':'AVALIAÇÃO','points · $1.00 / point':'pontos · $1,00 / ponto','BONUS CYCLE':'CICLO DE BÔNUS','January → December':'Janeiro → Dezembro','EVALUATION PERIOD':'PERÍODO DE AVALIAÇÃO','Manual preparation':'Preparação manual','After confirmation, these settings will become the operating rules for your workspace.':'Após a confirmação, estas configurações se tornarão as regras operacionais do seu workspace.','Back':'Voltar','Save & Continue':'Salvar e continuar','Confirm & Start KORbuild':'Confirmar e iniciar KORbuild','Setup completed':'Configuração concluída','Saving...':'Salvando...','We couldn’t save this step.':'Não foi possível salvar esta etapa.',"We couldn't save this step.":'Não foi possível salvar esta etapa.','Please try again.':'Tente novamente.','Unable to load workspace setup.':'Não foi possível carregar a configuração do workspace.','We couldn’t save the setup.':'Não foi possível salvar a configuração.',"We couldn't save the setup.":'Não foi possível salvar a configuração.','Sunday':'Domingo','Monday':'Segunda-feira','Tuesday':'Terça-feira','Wednesday':'Quarta-feira','Thursday':'Quinta-feira','Friday':'Sexta-feira','Saturday':'Sábado','January':'Janeiro','February':'Fevereiro','March':'Março','April':'Abril','May':'Maio','June':'Junho','July':'Julho','August':'Agosto','September':'Setembro','October':'Outubro','November':'Novembro','December':'Dezembro'
  };
